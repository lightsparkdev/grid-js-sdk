...
export interface ActionApproveResponse {
   ...
   */
  transferDetails?: ActionApproveResponse.TransferDetails;
}

export namespace ActionApproveResponse {
  /**
   * Details of a transfer-type agent action (TRANSFER_OUT or TRANSFER_IN).
   */
...
export interface ActionRejectResponse {
   ...
   * Details of a transfer-type agent action (TRANSFER_OUT or TRANSFER_IN).
   */
  transferDetails?: ActionRejectResponse.TransferDetails;
}

export namespace ActionRejectResponse {
  /**
   * Details of a transfer-type agent action (TRANSFER_OUT or TRANSFER_IN).
   */
  export interface TransferDetails {
