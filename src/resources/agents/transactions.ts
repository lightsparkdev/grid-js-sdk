...
export class Transactions extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.agents.transactions.approve(
   *   'actionId',
   *   { agentId: 'agentId' },
   * );
   * ```
  ...
  ): APIPromise<TransactionApproveResponse> {
   ...
   * @example
   * ```ts
   * const response = await client.agents.transactions.reject(
   *   'actionId',
   *   { agentId: 'agentId' },
   * );
   * ```
  ...
  reject(
    ...
    options?: RequestOptions,
  ): APIPromise<TransactionRejectResponse> {
