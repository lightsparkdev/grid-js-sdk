...
export interface CustomerCreateParams {
  CreateCustomerRequest:
    | CustomerCreateParams.CustomersIndividualCustomerUpdate
    | CustomerCreateParams.CustomersBusinessCustomerUpdate;
}

export namespace CustomerCreateParams {
  export interface CustomersIndividualCustomerUpdate
    extends Omit<CustomersAPI.IndividualCustomerUpdate, 'customerType'> {
    /**
  ...
  export interface CustomersBusinessCustomerUpdate
    extends Omit<CustomersAPI.BusinessCustomerUpdate, 'customerType'> {
    /**
     * Customer type discriminator
     */
    customerType: 'INDIVIDUAL' | 'BUSINESS';
...
export interface CustomerUpdateParams {
  UpdateCustomerRequest:
    | CustomerUpdateParams.CustomersIndividualCustomerUpdate
    | CustomerUpdateParams.CustomersBusinessCustomerUpdate;
}
