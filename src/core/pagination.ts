...
import { LightsparkGridError } from './error';
...
export abstract class AbstractPage<Item> implements AsyncIterable<Item> {
  ...
  constructor(client: LightsparkGrid, response: Response, body: unknown, options: FinalRequestOptions) {
    this.#client = client;
