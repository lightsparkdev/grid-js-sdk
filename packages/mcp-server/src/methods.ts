...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.agents.retrieveApprovals',
    fullyQualifiedName: 'agents.retrieveApprovals',
    httpMethod: 'get',
  ...
  {
    clientCallName: 'client.agents.me.list',
    fullyQualifiedName: 'agents.me.list',
    httpMethod: 'get',
    httpPath: '/agents/me',
  },
  {
    clientCallName: 'client.agents.me.retrieveInternalAccounts',
    fullyQualifiedName: 'agents.me.retrieveInternalAccounts',
    httpMethod: 'get',
    httpPath: '/agents/me/internal-accounts',
  },
  {
    clientCallName: 'client.agents.me.transferIn',
    fullyQualifiedName: 'agents.me.transferIn',
    httpMethod: 'post',
    httpPath: '/agents/me/transfer-in',
  },
  {
    clientCallName: 'client.agents.me.transferOut',
    fullyQualifiedName: 'agents.me.transferOut',
    httpMethod: 'post',
  ...
  {
    clientCallName: 'client.agents.me.externalAccounts.externalAccounts',
    fullyQualifiedName: 'agents.me.externalAccounts.externalAccounts',
    httpMethod: 'post',
    httpPath: '/agents/me/external-accounts',
  },
  {
    clientCallName: 'client.agents.me.externalAccounts.retrieveExternalAccounts',
    fullyQualifiedName: 'agents.me.externalAccounts.retrieveExternalAccounts',
    httpMethod: 'get',
    httpPath: '/agents/me/external-accounts',
  },
  {
    clientCallName: 'client.agents.deviceCodes.deviceCodes',
    fullyQualifiedName: 'agents.deviceCodes.deviceCodes',
    httpMethod: 'post',
  ...
  {
    clientCallName: 'client.agents.deviceCodes.retrieveStatus',
    fullyQualifiedName: 'agents.deviceCodes.retrieveStatus',
    httpMethod: 'get',
