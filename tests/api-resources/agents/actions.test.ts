...
describe('resource actions', () => {
  ...
  test.skip('approve: only required params', async () => {
    const responsePromise = client.agents.actions.approve('actionId', { agentId: 'agentId' });
  ...
  test.skip('reject: only required params', async () => {
    const responsePromise = client.agents.actions.reject('actionId', { agentId: 'agentId' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('reject: required and optional params', async () => {
    const response = await client.agents.actions.reject('actionId', {
      agentId: 'agentId',
