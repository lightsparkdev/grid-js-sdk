...
describe('resource externalAccounts', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.customers.externalAccounts.retrieve('externalAccountId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete', async () => {
    const responsePromise = client.customers.externalAccounts.delete('externalAccountId');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('challenge: only required params', async () => {
    const responsePromise = client.customers.externalAccounts.challenge('externalAccountId', {
  ...
  test.skip('challenge: required and optional params', async () => {
    const response = await client.customers.externalAccounts.challenge('externalAccountId', {
      method: 'WALLET_SIGNATURE',
    });
  });
  ...
  test.skip('verify: only required params', async () => {
    const responsePromise = client.customers.externalAccounts.verify('externalAccountId', {
  ...
  test.skip('verify: required and optional params', async () => {
    const response = await client.customers.externalAccounts.verify('externalAccountId', {
      signature: '0x52d75f01c9e7b8b2ce2fbcbd21bfeeee7bcd1a2f01ce6b8ad9a67a45e83a8f5d1c',
